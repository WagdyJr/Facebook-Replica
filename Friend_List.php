<?php
    ...
    $UID = $_SESSION['UID'];
    $sql = "SELECT * FROM friendlist WHERE user1 = '$UID'";
    $result = $db->query($sql);
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="profile-content">
               ...
               <div class="tab-content p-0">
                  ...
                  <div class="tab-pane fade in active show" id="profile-friends">
                     <h4 class="m-t-0 m-b-20" style="color: white;">Friend List (14)</h4>
                     <!-- begin row -->
                     <div class="row row-space-2">
                        ...
                        <?php
                            while($row = $result->fetch_assoc()){
                                $user2 = $row["user2"];
                                $sql2 = "SELECT fName,lName,Nickname FROM user WHERE UID = '$user2'";
                           ...
                           <div class="p-10 bg-white">
                              <div class="media media-xs overflow-visible">
                                 ...
                                 <div class="media-body valign-middle">
                                    <b class="text-inverse"><?php echo $name ?></b>
                                 </div>
