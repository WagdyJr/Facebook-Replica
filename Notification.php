                    ...
                    <li class="position-relative booking">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h5 class="mb-4"><?php echo $name ?><span class="badge badge-primary mx-3"style="font-weight:bold;"></h5>
                               
                               
                                <div class="mb-5">
                                    <span class="mr-2 d-block d-sm-inline-block mb-1 mb-sm-0" style="font-weight:bold;"><?php echo $row["user2"];?> :</span>
                                    <span class="border-right pr-2 mr-2"style="font-weight:bold;"><?php echo $row["description"];?></span>
