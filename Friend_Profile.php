<?php
    ...
    $is_already_friends = FALSE;
    $check_req_sender = FALSE;
    $check_req_receiver = FALSE;

    $sql = "SELECT * FROM user WHERE UID = '$user2ID'";
    $result = $db->query($sql);
    ...
    $sql = "SELECT * FROM account WHERE UID = '$user2ID'";
    $result = $db->query($sql);
    while($row = $result->fetch_assoc()) {
        $about = $row["aboutMe"];
    ...
    $sql1 = "SELECT * FROM friendlist WHERE user1 = '$user2ID'";
    $result1 = $db->query($sql1);
    $count = mysqli_num_rows($result1);

    $sql = "SELECT Email,joiningDate,aboutMe FROM account WHERE UID= '$user2ID'";
    $result = $db->query($sql);
    while($row = $result->fetch_assoc()) {
        $email = $row["Email"];
        $aboutMe = $row["aboutMe"];
    ...
    if ($result->fetch_assoc() == 1) {
        $is_already_friends = TRUE;
    }
    elseif($result->fetch_assoc() == 0){
        $sql1 = "SELECT * FROM friendrequest WHERE UID = '$UID'";
        $result = $db->query($sql);
        if ($result->fetch_assoc() == 1) {
            $check_req_sender = TRUE;
        }
    }
    else{
        $sql1 = "SELECT * FROM friendrequest WHERE user2 = '$user2ID'";
        $result = $db->query($sql);
        if ($result->fetch_assoc() == 1) {
            $check_req_receiver= TRUE;
        }
    }


   
    $sql1 = "SELECT * FROM post WHERE UID = '$user2ID'";
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col logo_section">
                        <div class="full">
                            <div class="center-desk">
                                <div class="logo">
                                    <a <?php unset($_SESSION['user2ID']);?> href="Timeline.php"><img src="images/logo.jpg" alt="logo" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="limit-box">
                                <nav class="main-menu">
                                    <ul class="menu-area-main">
                                        <li > <a <?php unset($_SESSION['user2ID']);?> href="Timeline.php">Home</a> </li>
                                        <li > <a <?php unset($_SESSION['user2ID']);?> href="Profile.php">Profile</a> </li>   
                                        <li> <a <?php unset($_SESSION['user2ID']);?> href="Friend_Request.php">FriendRequest</a> </li>
                                        <li> <a <?php unset($_SESSION['user2ID']);?> href="Notification.php">Notification</a> </li>
                                        <li> <a <?php unset($_SESSION['user2ID']);?> href="logout.php">Logout</a> </li>
                ...
                <div class="header-links">
                    <ul class="links d-flex align-items-center mt-3 mt-md-0">
                        <li class="header-link-item d-flex align-items-center active">
                            ...
                            <a class="pt-1px d-none d-md-block" <?php unset($_SESSION['user2ID']);?> href="Timeline.php">>Timeline</a>
                        </li>
                        ...
                        <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
                            ...
                            <a class="pt-1px d-none d-md-block" href="Friend_List.html">Friends <span class="text-muted tx-12"><?php echo $count ?></span></a>
                        </li>
                        <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
                    ...
                    <div class="card rounded">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <p class="tx-11 text-muted"><?php echo $uploaded;?></p>
                            </div>
                        </div>
                        <div class="card-body">
                            <p class="mb-3 tx-14"><?php echo $caption;?></p>
                            <?php if (!empty($image)){ $imageURL = 'uploads/'.$image;  ?>
